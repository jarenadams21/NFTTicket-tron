...
export function Hero() {
    ...
    return (
        <section
        class="overflow-hidden bg-[url(https://unsplash.com/photos/bn-D2bCvpik/download?ixid=MnwxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNjY4MzExNDYy&force=true&w=2400)] bg-cover bg-center bg-no-repeat"
      >
        <div class="bg-black/25 p-8 md:p-12 lg:px-16 lg:py-24">
          <div class="max-w-lg text-center sm:text-left">
            ...
            >
              Find events to match your style and pay using JustPass.
            </p>
